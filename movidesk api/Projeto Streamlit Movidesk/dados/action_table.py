...
dia_fim = 16
ano_request = '2021'
initial_date_request = str(dia_inicio) + '-' + mes_atual + '-' + ano_request
final_date_request = str(dia_fim) + '-' + mes_atual + '-' + ano_request
titulo = ano_request + '-' + mes_atual
arqsaida= r'relatorio-{}.csv'.format(titulo)


### Define dia de inicio e de fim, o mês e o ano da query, e realiza a consulta
tickets = request_tickets(dia_inicio, dia_fim, mes_atual, ano_request)
